...
This week's [Tidy Tuesday Project](https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/2022-01-04) is technically a "Bring your own data" week. As such, I chose to get some practice connecting to data sources through the use of APIs. I also chose this oppurtunity to play around some more with [Spotify](https://developer.spotify.com/) data. Namely, for one of my favorite bands, [__Phish__](https://en.wikipedia.org/wiki/Phish)!

## Documentation

[Spotify Developer Data Dictionary](https://developer.spotify.com/documentation/web-api/reference/#/operations/get-audio-features)
...
__Limitations:__ Likely missing a few data points due to songs names with a syntax of [Song Name] + [Live at Venue].
...
```{r Phish Song Timeline, fig.height=15, fig.width=8}
...
```{r Phish Spotify Features, fig.height=17, fig.width=7}
