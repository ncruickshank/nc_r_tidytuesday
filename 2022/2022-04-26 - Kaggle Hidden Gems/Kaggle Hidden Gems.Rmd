...
review_cloud <- wordcloud(words = df$word, freq = df$freq, min.freg = 1,
...
```{r}
test_url <- hidden_gems$notebook[1]
tweet <- hidden_gems$author_twitter[1]
...
# finding elements
followers_xpath <- remDr$findElement(using = "xpath", '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div/div/div[2]/div/div/div/div[2]/div[5]/div[2]/a/span[1]/span')
followers_xpath$getElementAttribute('name')
