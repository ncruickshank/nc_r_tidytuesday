...
![Unsplash Park Stock Photo](images/dwayne-hills-JaXlk3fKSWk-unsplash.jpg)
...
```{r points_over_time_by_metric, fig.height=6, fig.width=10}
tidy_parks %>%
...
This is all well and good, but what cities have seen the greatest surge in `total_points` from 2012 to 2020?

## Relationship between spending per resident and total rank

```{r spending_by_total_points}
tidy_parks %>%
