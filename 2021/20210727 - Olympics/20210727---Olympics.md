...
![](20210727---Olympics_files/figure-gfm/History%20of%20Russian%20Olympic%20Doping-1.png)<!-- -->

**Note:** My choice to dive into Russia specifically was based on the
viewing the documentary Icarus, and the countries banning from the most
recent (2021) Summer Olypmic games. Further analysis could provide a
similar history for other prominent countries at the Olympics (i.e.,
United States, Germany, Italy, Great Britain). Alternatively, a
comparitive analysis evaluating medals against blood doping could be
done for each of the top countries.
