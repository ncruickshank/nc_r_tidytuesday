...
The following analysis was performed on the Avatar: the Last Airbender script, as compiled by the r4ds tidytuesday community. The core dataset (`avatar.csv`), consists of the following variables:
